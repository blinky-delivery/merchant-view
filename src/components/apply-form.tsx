...
export function ApplyForm({
    ...
    const storeTypesQuery = useQuery<StoreType[], Error>({
        queryKey: ['storeTypes'],
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <Popover open={storeTypeOpen} onOpenChange={setStoreTypeOpen}>
                                            <PopoverTrigger asChild>
                                                ...
                                                >
                                                    {storeTypeValue
                                                        ? storeTypesQuery.data?.find((type) => type.name === storeTypeValue)?.name
                                                        : "Select a store type"}
                                                            ...
                                                            {storeTypesQuery.data?.map((type) => (
                                                                <CommandItem
                                                                    ...
                                                                    onSelect={(currentValue) => {
                                                                        ...
                                                                        field.handleChange(storeTypesQuery.data?.find((type) => type.name === currentValue)?.id || 0)
                                                                    }}
                                                                >
                                                                    {type.name}
                                                                    <Check
                                ...
                                <div className='grid gap-2'>
                                    ...
                                    <Popover open={cityOpen} onOpenChange={setCityOpen}>
                                        <PopoverTrigger asChild>
                                            ...
                                            >
                                                {cityValue
                                                    ? citiesQuery.data?.find((city) => city.name === cityValue)?.name
                                                    : "Select a city"}
                                                <ChevronsUpDown className="opacity-50" />
                                            </Button>
                                        </PopoverTrigger>
                                                        ...
                                                        {citiesQuery.data?.map((city) => (
                                                            <CommandItem
                                                                ...
                                                                onSelect={(currentValue) => {
                                                                    ...
                                                                    setCityOpen(false)
                                                                    field.handleChange(citiesQuery.data?.find((city) => city.name === currentValue)?.id || 0)
                                                                }}
                                                            >
                                                                {city.name}
                                                                <Check
